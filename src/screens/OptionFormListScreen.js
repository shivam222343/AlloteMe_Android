        ...
        <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <Text style={styles.sectionHeading}>Select a Percentile Option List</Text>
...
const styles = StyleSheet.create({
    ...
    sectionHeading: { fontSize: 15, fontWeight: '700', color: Colors.text.secondary, marginBottom: 20 },
    grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 20, justifyContent: 'flex-start' },
    gridItemContainer: { position: 'relative', width: (Dimensions.get('window').width - 60) / 2, maxWidth: 160, marginBottom: 10 },
    gridItem: {
    ...
    percentileText: { fontSize: 18, fontWeight: '800' },
