...
const AttendanceExportModal = ({ visible, onClose, clubs = [] }) => {
    ...
    const generateCSV = (data) => {
        ...
        // Table Header
        csv += 'Member Name,Artist Id,Email,';
...
<body>
    <div class="report-header">
        ...
        <p>${clubName} • Aura Club Management System</p>
    </div>
    ...
    <div class="footer">
        This is a system-generated document. &copy; ${new Date().getFullYear()} Aura Club Management System.
    </div>
</body>
</html>`;
    };
    ...
    const generateWarningCSV = (data) => {
        ...
        csv += `Generated on: ${new Date().toLocaleString()}\n\n`;
        csv += 'Member Name,Artist Id,Email,Phone,Role,Consecutive Missed,Joined At\n';
...
<body>
    ...
    <div style="margin-top: 40px; font-size: 11px; color: #999; text-align: center;">
        Generated by Aura Management System
    </div>
</body>
</html>`;
    };
